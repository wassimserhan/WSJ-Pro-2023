...
<section id="<?php echo $section_id ?>" class="layout-with-form"
  style="<?php if($gray_bg) echo 'background-color: #f1f1f1;'?>">

  <h1 class=" layout-with-form__headline"><?php echo $headline ?></h1>
  <div class="layout-with-form__card">

    <figure class="layout-with-form__fig-info">
      <img loading="lazy" src="<?php echo  $hero_image_right; ?>" alt="<?php echo $alt_r; ?>"
        title="<?php echo $title_r; ?>">
    </figure>

    <article class="layout-with-form__detail" style="<?php echo get_sub_field('margin_top')?>">

      <div class="layout-with-form__copy"><?php echo nl2br ($details) ?></div>

      <?php if($bullets): ?>

      <ol class="layout-with-form__bullet-list">
        <?php foreach ( $bullets as $bullet ): ?>
        <li class="layout-with-form__bullet">
          <?php if($bullet['bullet_title']) :?>
          <span class="layout-with-form__bullet-title"><?php echo $bullet['bullet_title'];?></span>
      ...
      <button id="formModal" class="btn btn--layout-with-form">
        <a <?php echo get_sub_field('hero_utag')?> class="btn--layout-with-form__link" href="<?php echo $cta['url'] ?>"
...
$form_thankyou = get_sub_field('form_thank_you');
$form_conf_msg = get_sub_field('form_confirmation_msg');
...
<section id="layout-with-form__modal-container" class="layout-with-form layout-with-form__modal-container">
  <div class="layout-with-form__modal">
    <button id="layout-with-form__modal-close" class="layout-with-form__button-close-modal">X</button>

    <article class="layout-with-form__wrapper">

      <?php if ($form_headline): ?>
      <h2 class="layout-with-form__wrapper__headline">
        <?php echo $form_headline; ?>
      </h2>
      <?php endif; ?>
      <?php if( $form_image ): ?>
      <figure class="layout-with-form__fig">
        <img class="layout-with-form__fig--img lazyload" data-src="<?php echo $form_image ?>" alt="<?php echo $alt ?>"
          title="<?php echo $title ?>">
      </figure>
      <?php endif; ?>


      <div class="layout-with-form__wrapper__container">


        <?php if ($description): ?>
        <p class="layout-with-form-description dark-underline">
        ...
        <div class="layout-with-form-success-div thanks hidden">
        ...
        <form id="form2" class="layout-with-form-container wsjpro-form">
          <input value="<?php echo $formId ?>" type="hidden" name="elqFormName">
          ...
          <div id="mc_embed_signup_scroll">
            <div class="mc-field-group-wrapper display-flex flex-col-mobile">
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <input type="text" class="elq-item-input form__input firstName" name="firstName" id="fname" value=""
                  placeholder=" ">
                <div class="label form__label">First Name<span>*</span></div>
              </div>
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <input type="text" class="elq-item-input form__input lastName" name="lastName" id="lname" value=""
                  placeholder=" ">
            ...
            <div class="mc-field-group-wrapper display-flex flex-col-mobile">
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <input type="email" class="elq-item-input form__input emailAddress" name="emailAddress" id="email"
                  value="" placeholder=" ">
                <div class="label form__label">Email Address<span>*</span></div>
              </div>
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <input type="text" class="elq-item-input form__input busPhone" name="busPhone" id="phone" value=""
                  placeholder=" ">
            ...
            <div class="mc-field-group-wrapper display-flex flex-col-mobile">
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <input type="text" class="elq-item-input form__input title" name="title" id="title" value=""
                  placeholder=" ">
                <div class="label form__label">Job Title<span>*</span></div>
              </div>
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <input type="text" class="elq-item-input form__input company" name="company" id="company" value=""
                  placeholder=" ">
            ...
            <div class="mc-field-group-wrapper display-flex flex-col-mobile">
              <div class="mc-field-group form__helper custom-col-6-md padding-10">
                <select id="industry" name="industry1" class="u-full-width form__select industry">
                  ...
                  <option data-type="industry" value="Advertising and Public Relations">Advertising and Public
                    Relations
                  </option>
                  ...
                  <option data-type="industry" value="Business and Consumer Services">Business and Consumer
                    Services
                  </option>
                  ...
                  <option data-type="industry" value="Computers/Information Technology">Computers/Information
                    Technology
                  </option>
                  ...
                  <option data-type="industry" value="Environment and Waste Management">Environment and Waste
                    Management
                  </option>
                  ...
                  <option data-type="industry" value="Hotels Restaurants and Casinos">Hotels Restaurants and
                    Casinos
                  </option>
                  ...
                  <option data-type="industry" value="Machinery and Industrial Goods">Machinery and Industrial
                    Goods
                  </option>
              ...
              <div class="mc-field-group custom-col-6-md padding-10 form-first-select-mobile">
                <select id="country" name="country" class="u-full-width form__select country">
            ...
            <div class="mc-field-group-wrapper display-flex flex-col-mobile state-form-field always-hide">
              <div class="mc-field-group custom-col-6-md padding-10 form-first-select-mobile">
                <select id="state" name="stateProv" class="u-full-width form__select state">
                  ...
                  <option data-type="state" data-filter="united states" value="MASSACHUSETTS">MASSACHUSETTS
                  </option>
                  ...
                  <option data-type="state" data-filter="united states" value="NEW HAMPSHIRE">NEW HAMPSHIRE
                  </option>
                  ...
                  <option data-type="state" data-filter="united states" value="NORTH CAROLINA">NORTH CAROLINA
                  </option>
                  ...
                  <option data-type="state" data-filter="united states" value="SOUTH CAROLINA">SOUTH CAROLINA
                  </option>
                  ...
                  <option data-type="state" data-filter="united states" value="WEST VIRGINIA">WEST VIRGINIA
                  </option>
                  ...
                  <option data-type="state" data-filter="canada" VALUE="BRITISH COLUMBIA">BRITISH COLUMBIA
                  </option>
                  ...
                  <option data-type="state" data-filter="canada" VALUE="NEWFOUNDLAND AND LABRADOR">NEWFOUNDLAND
                    AND
                    LABRADOR</option>
                  <option data-type="state" data-filter="canada" VALUE="NORTHWEST TERRITORIES">NORTHWEST
                    TERRITORIES
                  </option>
            ...
            <p class="legal">
              <input id="field1002" name="DJ_OptIn_Checkbox" type="checkbox" value="Dow Jones Opt-in"
                style="display:inline; margin:0 1rem; min-width: 10px;min-height: 1rem;">
              I would like to receive updates and special offers from Dow Jones and affiliates, including
              recommended
              content or information on upcoming events. I can unsubscribe at any time. By clicking the button
              below,
              you
            ...
            <input type="hidden" name="formName" id="fe12899" value="<?php echo $form_id ?>">

            <input type="hidden" name="formId" id="fe12900"
              value="https://s716031822.t.eloqua.com/e/f2?elqFormName=<?php echo $formId ?>&elqSiteID=716031822">

            <!--eof Product of Interest input to change-->
            <input type="hidden" name="RedirectValuehiddenField" id="fe12900" value="">
